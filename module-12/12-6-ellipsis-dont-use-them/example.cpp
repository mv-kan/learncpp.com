...
int main()
{
    ...
    // ellipsis does not have type checking, we passed double here and it will lead to
    /// Undefined Behavior, which is bad. this is because it is passing bit of data with out any type info about these bits
    std::cout << findAverage(6, 1.0, 2.f, 3, 4, 5, 6) << '\n';
