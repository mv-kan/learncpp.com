...
// 4294967296 is sqrt(UINT64_MAX)
// #define UINT_INTERNAL_BASE 4294967296 // UINT_INTERNAL_BASE * UINT_INTERNAL_BASE mustn't overflow 64 bits
...
public:
    ...
    void Multiply(const UIntInternal num);
